...
export function SettingsContainer() {
    ...
    useEffect(() => {
        const savedSettings =
            getFromLocalStorage<Array<SettingItem>>(settingsKey);
        if (savedSettings) {
            ...
            setSettings([
                ...
                {
                    id: 'expressions_history_max_items',
                    type: 'number',
                    name: 'Maximum number of expressions in history tab',
                    value: 100,
                },
                {
                    id: 'requests_history_max_items',
                    type: 'number',
                    name: 'Maximum number of requests in history tab',
                    value: 100,
                },
            ]);
        }
