                ...
                },
                {
                    ...
                    render: (_, record) => <Space size="small">
                        <DrawerButton
                            ...
                            footer={
                                <Space size="small">
                                    <Button type="link" onClick={() => props.setResource(record.response)}>Use response</Button>
                                </Space>
                            }
                        />
                        <Popconfirm title="Use this URL?" onConfirm={() => props.setUrl(record.url)}>
                            <Button type="link">Use</Button>
                        </Popconfirm>
                        <Button type="link" onClick={() => props.copyToClickboard(record.url, "The URL has been copied", "Error while copying the URL")}>Copy</Button>
                    </Space>
                }
            ]}
