                ...
                },
                {
                    ...
                    render: (_, record) => (
                        <Space size="middle">
                            ...
                            <Button type="link" onClick={() => props.copyToClickboard(record.expression, "The FHIRPath expression has been copied", "Error while copying the FHIRPath expression")}>Copy</Button>
                        </Space>
                    ),
                },
            ]}
